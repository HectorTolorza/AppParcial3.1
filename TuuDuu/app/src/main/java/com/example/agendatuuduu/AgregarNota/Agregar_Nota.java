...
import com.example.agendatuuduu.MenuPrincipal;
...
public class Agregar_Nota extends AppCompatActivity {
    ...
    private void Agregar_Nota(){
        ...
        if (!uid_usuario.equals("") && !correo_usuario.equals("") && !fecha_hora_actual.equals("") && !titulo.equals("") && !descripcion.equals("") && !estado.equals("")){
